...
export class QlProductComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.productForm = this.fb.group({
      ...
      productMarketprice: [0, [Validators.required]],
      productRAM: [null, [Validators.required]],
  ...
  showModal(id, action): void {
    ...
    if (action == 'VIEW') {
      ...
      this.listOfData.forEach((item) => {
        if (item.productID == id) {
          ...
          this.productForm.controls.productRAM.setValue(
            item.productRAM
          );
          this.productForm.controls.productImportPrice.setValue(
            item.productImportPrice
          );
          this.productForm.controls.productMarketprice.setValue(
            item.productImportPrice
          );
    ...
    if (action == 'EDIT') {
      ...
      this.listOfData.forEach((item) => {
        if (item.productID == id) {
          ...
          this.productForm.controls.productPrice.setValue(item.productPrice);
          this.productForm.controls.productMarketprice.setValue(item.productMarketprice);
          this.productForm.controls.productDescription.setValue(
            item.productDescription
          );
          this.productForm.controls.productImportPrice.setValue(
    ...
    if (action == 'INSERT') {
      ...
      this.productForm.controls.productRAM.setValue(null);
      this.productForm.controls.productImportPrice.setValue(0);
      this.productForm.controls.productMarketprice.setValue(0);
  ...
  handleOk(): void {
    ...
    this.product.productMarketprice = this.productForm.controls.productMarketprice.value;
    this.product.productQuantily =
      this.productForm.controls.productQuantily.value;
      this.product.productRAM =
      this.productForm.controls.productRAM.value;
